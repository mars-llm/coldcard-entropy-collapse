...
Fixed releases begin with Mk2/Mk3 4.2.0, Mk4/Mk5 standard 5.6.0, Q standard 1.5.0Q, Mk4/Mk5 Edge 6.6.0X, and Q Edge 6.6.0QX. Updating fixes new seed generation; it does not repair a seed that already exists. Coinkite does not consider a seed at risk from this issue alone if at least 50 fair, independent, private dice rolls were added when it was created. A strong, unique BIP39 passphrase adds a separate barrier, but Coinkite still advises replacing the affected seed as soon as practical.
